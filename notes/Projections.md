...
$$\frac{\partial f(0)}{\partial\lambda} = 0 \rightarrow 1 = u^T u, \space \frac{\partial f(0)}{\partial u} = 0 \rightarrow 0 = Su - \lambda u$$$$\text{Fumble that about and you get }Su=\lambda u \text{ where S is cov mat, u is (L2 normalized) eigenvector,} \lambda = \text{eigenvalue}$$
